...
export default function TradingModuleSubmodulePage({
  params,
}: {
  ...
  const module = tradingModules.find((item) => item.id === params.module)
    ...
    return (
      <>
        ...
        <main className="container mx-auto px-4 py-16 text-white">
          ...
          <Link href={params.module ? `/trading/${params.module}` : "/trading"} className="mt-4 inline-block text-lime-300 underline">
            Volver al módulo
          </Link>
        </main>
      </>
  ...
  return (
    <>
      ...
      <main className="container mx-auto px-4 py-12 text-white">
        <Link href={`/trading/${module.id}`} className="text-sm text-lime-300 underline">
