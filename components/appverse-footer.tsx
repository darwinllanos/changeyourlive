...
const defaultContent: FooterContent = {
  tagline: "Cambia tu vida con Innova en 180 dias, contactame para mas informacion.",
  copyright: "© 2025 — DARWINDEV, All rights reserved.",
}
    ...
    <section className="text-white">
      ...
      <div className="container mx-auto px-4 pt-12 sm:pt-16">
        <div className="flex justify-center">
          ...
          >
            <a href="https://wa.me/573163746711" target="_blank" rel="noopener noreferrer">
              Contactame
            </a>
          </Button>
        </div>
      ...
      <div className="container mx-auto px-4 py-12 sm:py-16">
        <Card className="relative overflow-hidden rounded-3xl liquid-glass p-6 sm:p-10">
          <div className="relative grid items-center gap-8 md:grid-cols-2">
            {/* Left copy */}
            <div>
              <p className="mb-2 text-[11px] tracking-widest text-lime-300">Genera ingresos de manera digital</p>
              <h3 className="text-2xl font-bold leading-tight text-white sm:text-3xl">
                Negocios Digitales Hechos Para Ti
              </h3>
              <p className="mt-2 max-w-prose text-sm text-neutral-400">
                Lleva tus finanzas a un siguiente nivel con nuestros negocios digitales, 
              </p>
            </div>
                ...
                <div className="relative aspect-[9/19] w-full overflow-hidden rounded-2xl bg-black">
                  ...
                  <div className="relative p-3">
                    ...
                    <div className="space-y-1 px-1">
                      <div className="text-5xl font-extrabold text-lime-300">INNOVA</div>
                      <p className="text-xs text-white/80">SALTOS CUANTICOS</p>
                      <div className="mt-3 inline-flex items-center rounded-full bg-black/40 px-2 py-0.5 text-[10px] uppercase tracking-wider text-lime-300">
                        Justo cuando la uva penso que era su fin, se convirtio en vino. Salud por los nuevos comienzos!
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="grid gap-8 md:grid-cols-[1.2fr_1fr_1fr]">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-xl font-semibold text-white">changeyourlive</span>
              </div>
            ...
            <div className="grid grid-cols-2 gap-6 sm:grid-cols-3 md:grid-cols-2">
              <div>
                ...
                <ul className="space-y-2 text-sm text-neutral-300">
                  <li><Link href="#" className="hover:text-lime">Pagina Principal</Link></li>
