...
const defaultContent: FeaturesContent = {
  title: "Se nuestro siguiente caso de exito",
  subtitle: "Estas listo para cambiar tu vida?",
}
    ...
    <section id="features" className="container mx-auto px-4 py-16 sm:py-20">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <Card className="hidden md:block liquid-glass border border-white/20">
          <CardHeader>
            <p className="text-[11px] tracking-widest text-white/80">Educadores</p>
            <CardTitle className="mt-1 text-xl text-white">Educate junto con profesionales y deja que tu cuenta se vea asi mensualmente</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="liquid-glass border border-white/20">
          <CardHeader>
            <p className="text-[11px] tracking-widest text-white/80">INNOVA</p>
            <CardTitle className="mt-1 text-xl text-white">
              Deja de ser parte de la mayoria, date esa vida que tanto quieres, unete a nosotros y genera ingresos mediante los negocios digitales
            </CardTitle>
          </CardHeader>
          <CardContent>
